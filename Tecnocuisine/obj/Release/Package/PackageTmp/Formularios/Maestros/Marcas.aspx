<%@ Page Title="Marcas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="Tecnocuisine.Marcas" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div style="margin-left: 0px; margin-right: 0px;" class="row">
                        ...
                        <div class="col-md-2">
                            <a data-toggle="modal" data-backdrop="static" data-target="#modalAgregar" 
                                class="btn btn-primary dim" title="Agregar marca" onclick="vaciarInputs()"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtDescripcionMarca" class="form-control" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function vaciarFormulario() {
            ContentPlaceHolder1_txtDescripcionMarca.value = "";
            ContentPlaceHolder1_hiddenEditar.value = "";
            window.history.pushState('', 'Marcas', location.protocol + '//' + location.host + location.pathname);
