                                            ...
                                            <div class="ibox-content">
                                                <div style="margin-left: 0px; margin-right: 0px;" class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <a data-toggle="modal" data-backdrop="static" data-target="#ModalNuevoPais" title="Agregar pais"
                                                            class="btn btn-primary dim"
                                                            style="margin-right: 1%; float: right" onclick="limpiarInputs()"><i class='fa fa-plus'></i></a>
                                                    </div>
                                                </div>
