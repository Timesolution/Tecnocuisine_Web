<%@ Page Title="Imputar Pagos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImputarPagos.aspx.cs" Inherits="Tecnocuisine.Compras.ImputarPagos" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="p-xs">
                ...
                <div style="display: flex;">
                    <div style="display: flex; justify-content: flex-start">
                        <h3 style="color:#1ab394;font-weight: bold;">Proveedor</h3>
    ...
    <script>
        ...
        function ImputarCobranza(e) {
            ...
            $.ajax({
                method: "POST",
                url: "ImputarPagos.aspx/ImputarFacturas",
                data: '{listFacturas: "' + listFacImputar
                    + '" , ImporteCobro: "' + ingresadototal
                    + '" , idProveedor: "' + document.getElementById("ContentPlaceHolder1_idClienteFinal").value.split("-")[0].trim()
                ...
                success: (response) => {
                    if (response.d == "") {
                        window.location.href = "Pagos.aspx?m=5";
                    } else {
