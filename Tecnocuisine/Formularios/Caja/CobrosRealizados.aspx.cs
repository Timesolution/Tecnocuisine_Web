...
{
    public partial class CobrosRealizados : System.Web.UI.Page
    {
        ...
        public void FiltrarVentas(int idCli, string FechaD, string FechaH)
        {
            try
            {
                ...
                {
                    Tecnocuisine_API.Entitys.CobrosRealizados vd = new Tecnocuisine_API.Entitys.CobrosRealizados();
        ...
        public void CargarVentasPH2(Tecnocuisine_API.Entitys.CobrosRealizados cobro, Tecnocuisine_API.Entitys.Clientes cliente)
        {
            try
            {
                // < th > ID </ th > LISTO
