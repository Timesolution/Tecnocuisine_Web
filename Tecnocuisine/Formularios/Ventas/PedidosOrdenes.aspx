                                            ...
                                            <div class="ibox-content">
                                                <div style="margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div style="display: flex; margin-bottom: 20px">
                                                        <label style="margin-top: 5px; margin-left: 10px; margin-right: 10px">Origen</label>
                                                        <div>
                                                        ...
                                                        <label style="margin-top: 5px; margin-left: 10px; margin-right: 10px">Destino</label>
                                                        <div>
                                                        ...
                                                        <label style="margin-top: 5px; margin-left: 10px; margin-right: 10px">Estado</label>
                                                        <div>
