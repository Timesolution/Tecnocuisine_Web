<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetalleIngrediente.aspx.cs" Inherits="Tecnocuisine.Formularios.Ventas.DetalleIngrediente" %>
                            ...
                            <table class="table table-striped table-bordered table-hover " id="editable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= dtr["UnidadMedida"].ToString() %></td>
                                        <td>0</td>
                                        <td>0</td>
                                    </tr>
                            ...
                            <table class="table table-striped table-bordered table-hover " id="editable2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><%= dtr["SectorProductivo"].ToString() %></td>
                                        <td>
                                                <%= dtr["Producto"].ToString() %>
                                          <%--  <div class="folder-contents" style="display: none;">
                                                <!-- Contenido de la carpeta desplegable aquí -->
                                                <!-- Por ejemplo, puedes agregar detalles adicionales sobre el producto aquí -->
                                            </div>--%>
                                        </td>
