<%@ Page Title="Stock" Language="C#" AutoEventWireup="true" CodeBehind="StockPopUp.aspx.cs" Inherits="Tecnocuisine.StockPopUp" %>
...
<body>
    ...
    <form style="width:80% ;margin-top: 10%" id="form1" runat="server">
        <div>
