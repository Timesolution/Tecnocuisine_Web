<%@ Page Title="Entidades" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entidades.aspx.cs" Inherits="Tecnocuisine.Entidades" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>      
        ...
        function abrirdialog2(valor,text) {
            document.getElementById('<%= hiddenID.ClientID %>').value = valor;
            document.getElementById('ContentPlaceHolder1_txtDescripcion').value = text;   
