<%@ Page Title="Clasificaciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clasificaciones.aspx.cs" Inherits="Tecnocuisine.Clasificaciones" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="table-responsive"  >
                                <table class="table table-striped table-bordered table-hover " id="editable" >
                                    ...
                                    <tbody>
                                        <asp:PlaceHolder ID="phClasificaciones" runat="server"></asp:PlaceHolder>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                       <div class="col-sm-1">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtCodigoClasificacion" class="form-control" runat="server" />
                    ...
                    <div class="form-group" style="padding-top: 7%">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtDescripcionClasificacion" class="form-control" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function vaciarFormulario() {
            ...
            window.history.pushState('', 'Clasificaciones', location.protocol + '//' + location.host + location.pathname);
