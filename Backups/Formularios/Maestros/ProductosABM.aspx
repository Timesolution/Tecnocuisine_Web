                                            ...
                                            <div >
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <asp:LinkButton runat="server" ID="LinkButtonMarcas1" OnClientClick="editarMarcas()" class="btn btn-primary dim" data-toggle="modal" href="#modalMarcas"><i style="color: white"  class="fa fa-plus"></i></asp:LinkButton>
                                                        </span>
                                                    </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <a id="btnAgregarMarca" onclick="agregarMarca()" class=" btn btn-primary"><i class="fa fa-check"></i>&nbsp;Agregar </a>
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i>&nbsp;Cancelar</button>
  ...
  <script>
      ...
      function AgregarMarcaDesdeTxt(e) {
          if (e.keyCode === 13 && !e.shiftKey) {
              ...
              let MarcaFinal = idOption.split("_")[1] + " - " + txtMarca;
