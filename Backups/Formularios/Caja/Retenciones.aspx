<%@ Page Title="Cta Retenciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Retenciones.aspx.cs" Inherits="Tecnocuisine.Caja.Retenciones" %>
                                                ...
                                                <table class="table table-striped table-bordered table-hover " id="editable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style=" text-align: left; width: 5%;">Cliente/Proveedor</th>
                                                            <th style=" text-align: left; width: 5%;">Tipo</th>
                                                            <th style=" text-align: left; width: 5%;">Documento</th>
