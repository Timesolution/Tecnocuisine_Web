<%@ Page Title="Cobros" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CobrosCompra.aspx.cs" Inherits="Tecnocuisine.Compras.CobrosCompra" %>
  ...
  <%--  <div id="modalBusqueda" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    ...
    <script>
        ...
        function FiltrarCuentaCorriente() {
            ...
            window.location.href = "CobrosCompra.aspx?p=" + Proveedor.split("-")[0].trim();
        }
